...
async function run(argv) {
  ...
  try {
    ...
    const batchPlan = await createMergeBatchPlan(selectedResult.selected, options);
    ...
    const execution = await executeMergeBatch(batchPlan, options);
