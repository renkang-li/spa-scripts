...
async function run(argv) {
  ...
  try {
    const projectRows = await buildVersionProjectRows(allProjects);
    ...
    const batchPlan = await createVersionBatchPlan(selectedResult.selected, executionOptions);
    ...
    const execution = await executeVersionBatch(batchPlan, executionOptions);
