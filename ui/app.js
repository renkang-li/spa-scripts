...
function bindEvents() {
  ...
  elements.projectList.addEventListener('click', async (event) => {
    const badge = event.target.closest('.project-branch-badge');
    if (badge) {
  ...
  elements.projectList.innerHTML = visibleProjects.map((project) => `
    <label class="project-item">
      <div class="project-head">
        ...
        <div class="project-branch-badge mono" title="${escapeHtml(project.currentBranch)}" data-branch="${escapeHtml(project.currentBranch)}">
